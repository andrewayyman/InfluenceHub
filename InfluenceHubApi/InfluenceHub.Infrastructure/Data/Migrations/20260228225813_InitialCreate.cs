        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Platforms = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InfluencerTags", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Applications_Influencers_InfluencerId",
                        column: x => x.InfluencerId,
                        principalTable: "Influencers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostUrl = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    ...
                    ScreenshotPath = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CampaignReports_Applications_ApplicationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Applications_CampaignId_InfluencerId",
                table: "Applications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CampaignReports_Status",
                table: "CampaignReports",
                column: "Status");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CampaignTags_CampaignId_TagId",
                table: "CampaignTags",
                columns: new[] { "CampaignId", "TagId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InfluencerTags_InfluencerId_TagId",
                table: "InfluencerTags",
                columns: new[] { "InfluencerId", "TagId" },
                unique: true);

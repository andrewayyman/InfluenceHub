  ...
  return (
    <DashboardPage>
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 ih-surface rounded-[1.75rem] p-6 border border-white/8">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="rounded-xl border border-white/5 bg-white/5 p-4 flex gap-3 items-start ih-panel-hover transition-all">
                <div className="h-8 w-8 rounded-full bg-brand-500/20 text-brand-400 flex items-center justify-center shrink-0">
                  <Activity size={16} />
                </div>
                <div>
                  <p className="text-sm font-medium text-white mb-1">Conversion Rate</p>
              ...
              <div className="rounded-xl border border-white/5 bg-white/5 p-4 flex gap-3 items-start ih-panel-hover transition-all">
                ...
                <div>
                  <p className="text-sm font-medium text-white mb-1">Pending Responses</p>
                  <p className="text-xs text-slate-400">
                    {stats.pending > 0 
        ...
        <div className="ih-surface rounded-[1.75rem] p-6 border border-white/8 flex flex-col justify-between">
          <div>
            <h2 className="text-xl font-semibold text-white mb-4">Opportunities</h2>
